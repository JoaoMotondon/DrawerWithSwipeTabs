...
public class YouTubeFragment extends Fragment {
    ...
    private void changeColor() {
        ...
        window.setStatusBarColor(Color.parseColor("#96172e"));

        ColorDrawable colorDrawable = new ColorDrawable(Color.parseColor("#cd201f"));
        ((AppCompatActivity)getActivity()).getSupportActionBar().setBackgroundDrawable(colorDrawable);

        AppBarLayout appBarLayout = (AppBarLayout) getActivity().findViewById(R.id.app_bar);
        appBarLayout.setBackgroundColor(Color.parseColor("#cd201f"));
    }
}
