...
import com.motondon.drawerwithswipetabs.view.adapter.NewsImageAdapter;
...
public class NewsImagesFragment extends Fragment {

    @BindView(R.id.rv_image_list) RecyclerView recyclerView;
    private List<Pair<String, String>> callsItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_news_images, container, false);

        ButterKnife.bind(this, root);

        NewsImageAdapter adapter = new NewsImageAdapter(getContext());
        ...
        List<String> listImages =  Arrays.asList(imageUrls);
